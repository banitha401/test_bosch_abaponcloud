...
*        output =
  ...
  METHOD fill_master_data.
    data : lt_bp type table of zbsh_ab_bpa,
   ...
   append value #(
    ...
    append value #(
     ...
     insert zbsh_ab_bpa from table @lt_bp.
  ...
  METHOD fill_transaction_data.
    ...
    select * from zbsh_ab_bpa into table @data(lt_bpa).
  ...
  METHOD flush.
    delete from : zbsh_ab_bpa, zbsh_ab_product, zbsh_ab_so_hdr, zbsh_ab_so_item.
  ENDMETHOD.
ENDCLASS.
